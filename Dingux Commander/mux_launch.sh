...
SDL_ASSERT=always_ignore SDL_GAMECONTROLLERCONFIG=$(echo "$(grep "muOS-Keys" "/usr/lib/gamecontrollerdb.txt")" | sed -e 's/guide:b11/guide:b9/g; s/back:b9/back:b11/g') ./dingux --config "$DINGUX_DIR/dingux.cfg"
